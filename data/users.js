...
async function addUser(email, hashPassword, first, last, phone, admin) {
  try {
    const sql = `INSERT INTO user (email, hashed_pass, first, last, phone, admin) VALUES ('${email}', '${hashPassword}', '${first}', '${last}', '${phone}', '${admin}')`;
